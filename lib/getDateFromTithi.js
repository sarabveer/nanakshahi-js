 ...
 */
module.exports = ( year, month, tithi, paksh = false, leapMonth = false, leapDay = false ) => {
  ...
  const gregorianDate = new Date( Date.UTC( gregorianYear, gregorianMonth, gregorianDay ) )
