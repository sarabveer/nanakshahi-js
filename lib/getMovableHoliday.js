const getGregorianFromLunarDate = require( './getGregorianFromLunarDate' )
...
function getMovableHoliday( holiday, year = new Date().getFullYear() ) {
  ...
  const { gregorianDate, lunarDate } = getGregorianFromLunarDate( bikramiYear, lunarMonth, tithi, paksh ) // eslint-disable-line max-len
