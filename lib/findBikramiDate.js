...
const {
  astronomy: { universalFromStandard, lunarPhase },
 ...
 */
function findBikramiDate( date, astro = true, isJulian = false ) {
  ...
  const tithiFraction = mod( astro ? lunarPhase( sunrise ) : hinduLunarPhase( sunrise ), 1 )
