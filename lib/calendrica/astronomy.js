...
/*
  ...
  Note by Sarabveer Singh <me@sarabveer.me>:

  There two issues with the above moment:

  1. It sets Spica/Chitra at Aries/Mesha (0deg) instead of Libra (180deg).
  2. It is using Surya Sidhatta calculation for Solar Longitude, instead of the Tropical one.

  Under the Lahiri Ayanamsha, Spica/Chitra is set to 0deg Libra
  and it is assumed 285 C.E. is when both Tropical and Sidereal
  Solar Longitudes coincided with each other.

  Correct:
  Find moment when solarLongitude(t) = 180 deg, in Year 285 C.E.
  t = 103995.214253659 R.D.
*/
const SIDEREAL_START = precession( 103995.214253659 )
