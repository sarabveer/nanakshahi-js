const getDateFromLunarTithi = require( './getDateFromLunarTithi' )
const toUnicodeNum = require( './utils/toUnicodeNum' )
const movableHolidays = require( './json/movableHolidays' )
...
function getMovableHoliday( holiday, year = new Date().getFullYear() ) {
  ...
  const { gregorianDate, lunarDate } = getDateFromLunarTithi( bikramiYear, lunarMonth, tithi, paksh ) // eslint-disable-line max-len
